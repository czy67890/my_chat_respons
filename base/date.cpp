...
const int Date::k_julian_day_of_1970_01_01 = detail::getJulianDayNumber(1970, 1, 1);
}
using namespace czy;
using namespace czy::detail;
Date::Date(int y, int m, int d)
  : m_julian_day_number(getJulianDayNumber(y, m, d))
{
}

Date::Date(const struct tm& t)
  : m_julian_day_number(getJulianDayNumber(
        t.tm_year+1900,
        t.tm_mon+1,
        t.tm_mday))
{
...
{
  return getYearMonthDay(m_julian_day_number);
}